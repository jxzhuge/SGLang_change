...
| **TeleChat3** (36B)                 | `Tele-AI/TeleChat3-36B-Thinking`, `Tele-AI/TeleChat3-Coder-36B-Thinking` | TeleAI's third-generation bilingual large language model (36B) with advanced reasoning and code generation capabilities. Supports YaRN-based long-context scaling. |
