...
from sglang.srt.layers.rotary_embedding.telechat3_scaling_rope import (
    TeleChat3ScalingRotaryEmbedding,
)
...
def get_rope(
    ...
    if dual_chunk_attention_config is not None:
        ...
        if scaling_type == "llama3":
        ...
        elif scaling_type in ("telechat3-yarn", "telechat3_yarn"):
            # TeleChat3 uses a YaRN variant. Keep the same interpolation path
            # as YaRN, but route to the TeleChat-specific mscale formulation.
            original_max_position = _get_rope_param(
                rope_scaling,
                "original_max_position_embeddings",
                max_position,
            ...
            extra_kwargs["truncate"] = rope_scaling.get("truncate", True)
            rotary_emb = TeleChat3ScalingRotaryEmbedding(
                head_size,
                rotary_dim,
                original_max_position,
                base,
